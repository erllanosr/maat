...
import Avatar from "../../resources/icons/user_circle.svg";
                      ...
                      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
                        <div className="flex items-center space-x-3 mb-5">
                          ...
                          <div className="grow">
                            ...
                            <input
                              id="status-input"
                              className="form-input w-full p-2 bg-slate-100 border-transparent focus:bg-white focus:border-slate-300 placeholder-slate-500"
                              type="text"
                        ...
                        <div className="flex justify-between items-center">
                          <div className="grow flex space-x-5">
                            <button className="inline-flex items-center text-sm font-medium text-slate-600 hover:text-slate-700">
                              <svg className="w-4 h-4 fill-[var(--primaryColor)] mr-2" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div>
                            <button type="submit" className="btn-sm bg-[var(--primaryColor)] hover:bg-[var(--darkGreen)] rounded-md p-2 text-white whitespace-nowrap">
                              Send -&gt;
                            </button>
                          </div>
                        </div>
