      ...
      <div className="px-5 pt-5">
        <header>
          <h3 className="text-sm font-semibold text-slate-500 uppercase mb-1">
            <span className="text-slate-800">Most Popular CSR Event Types in 2023: Driving Social Change</span>
          </h3>
          <div className="text-2xl font-bold text-slate-800 mb-1">Community Service Events</div>
          <div className="text-sm">
            <span className="font-medium text-emerald-500">+24%</span> - 2023
          </div>
        </header>
      </div>
