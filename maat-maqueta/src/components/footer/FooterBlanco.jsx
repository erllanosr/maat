  ...
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8">
      <div className="grid row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-gray-800">
              Encuentra el equipo perfecto entre la red de profesionales mas completa del mercado.
            </p>
            <p className="mt-4 text-sm text-gray-800">
              Para llevar a cabo una idea, debes rodearte de personas que compartan tu pasión, desde MAAT, te queremos ayudar.
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm">
          <p className="text-base font-bold tracking-wide text-gray-900">Contactanos</p>
          <div className="flex">
          ...
          <div className="flex">
            ...
            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">info@MAAT.es</a>
          </div>
          <div className="flex">
        ...
        <div>
          <span className="text-base font-bold tracking-wide text-gray-900">Nuestras redes sociales</span>
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        ...
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          ...
          <li>
            <a href="/" className="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Política de privacidad</a>
          </li>
          <li>
            <a href="/" className="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Términos &amp; Condiciones</a>
          </li>
        </ul>
      </div>
    </div>
