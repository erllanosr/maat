          ...
          <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                <h1 className="text-3xl text-slate-800 font-bold mb-6">Entity information</h1>
                {/* htmlForm */}
                <form>
                  ...
                  <div className="flex items-center justify-between">
                    <Link className="bg-slate-200 text-black p-2 rounded-md text-sm hover:bg-slate-300" to="/registro">
                      <svg
