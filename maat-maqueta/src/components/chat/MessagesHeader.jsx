        ...
        <div className="flex items-center">
          ...
          <div className="flex -space-x-3 -ml-px">
            <a className="block" href="#0">
              <img className="rounded-full border-2 border-white box-content" src="https://geekazos.com/wp-content/uploads/2015/02/fb2.jpg" width="32" height="32" alt="User 01" />
            </a>
            <a className="block" href="#0">
              <img className="rounded-full border-2 border-white box-content" src="https://geekazos.com/wp-content/uploads/2015/02/fb2.jpg" width="32" height="32" alt="User 04" />
            </a>
          </div>
        </div>
